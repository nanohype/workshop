    ...
    >
      ...
      <div className="px-2.5 py-2">
        <div className="flex items-center gap-1.5">
          <div className="flex items-center justify-center w-5 h-5 rounded-full bg-yellow-600/15">
        ...
        {data.isWaiting && (
          <span className="inline-block text-[10px] mt-1 px-1.5 py-0.5 rounded-full bg-yellow-600/15 text-yellow-500">
            Awaiting approval
          </span>
        )}
      </div>
