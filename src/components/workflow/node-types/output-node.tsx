...
function OutputNode({ data, selected }: NodeProps & { data: OutputNodeData }) {
  return (
    ...
    >
      <div className="h-[2px] w-full bg-emerald-500 rounded-t-md" />

      <Handle type="target" position={Position.Top} className="!bg-emerald-500 !w-2.5 !h-2.5 !border-2 !border-card !ring-1 !ring-border" />
